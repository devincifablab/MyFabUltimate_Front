...
import { BellIcon, MenuIcon, XIcon, CubeIcon, LoginIcon } from '@heroicons/react/outline'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex">
              ...
              <div className="hidden md:ml-6 md:flex md:space-x-8">
                ...
                {navigations.map(navigation => {
                    return <Link href={navigation.href}>
                        <a
                    className={`${navigation.current? `border-indigo-500 text-gray-900`: `border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700`} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium`}
                  >
                    {navigation.name}
                  </a>
                    </Link>
            ...
            <div className="flex items-center">
              ...
              {isLogged?<div className="hidden md:ml-4 md:flex-shrink-0 md:flex md:items-center">
    ...
    <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
      ...
      <Menu.Item>
        ...
        <Disclosure.Panel className="md:hidden">
          <div className="pt-2 pb-3 space-y-1">
            {navigations.map(r=>{
              return(
                <a
              href={r.href}
              className={`${r.current? "bg-indigo-50 border-indigo-500 text-indigo-700": "border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700"} block pl-3 pr-4 py-2 border-l-4 text-base font-medium sm:pl-5 sm:pr-6`} 
            >
              {r.name}
            </a>
              );
          ...
          {isLogged?<div className="pt-4 pb-3 border-t border-gray-200">
